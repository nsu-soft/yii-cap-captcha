...
class Keys extends AbstractApi
{
    ...
    {
        $uri = $this->factory->createUri("{$this->baseUri}/server/keys");
    ...
    {
        $uri = $this->factory->createUri("{$this->baseUri}/server/keys/{$siteKey}");
    ...
    {
        $uri = $this->factory->createUri("{$this->baseUri}/server/keys/{$siteKey}/config");
    ...
    {
        $uri = $this->factory->createUri("{$this->baseUri}/server/keys/{$siteKey}/rotate-secret");
